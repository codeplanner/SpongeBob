...
Write-Host "using Ninject.Modules;" -ForegroundColor Darkgreen
Write-Host "using $($namespace).Core.Interfaces.Data;" -ForegroundColor Darkgreen
Write-Host "using $($namespace).Core.Interfaces.Service;" -ForegroundColor Darkgreen
Write-Host "using $($namespace).Data;" -ForegroundColor Darkgreen
Write-Host "using $($namespace).Service;" -ForegroundColor Darkgreen
