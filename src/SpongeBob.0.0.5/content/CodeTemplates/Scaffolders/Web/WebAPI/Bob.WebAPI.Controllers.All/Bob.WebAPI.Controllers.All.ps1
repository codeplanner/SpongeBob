[T4Scaffolding.Scaffolder(Description = "Enter a description of SpongeBob.WebAPI.Controllers.All here")][CmdletBinding()]
param(        
    [string]$Project,
	[string]$CodeLanguage,
...
$classes | ForEach{		
	...
	$_.Bases | ForEach{
		if($_.Name -eq "PersistentEntity"){							
			Scaffold Bob.WebAPI.Controller.For $current.Name -Force:$Force			
		}
